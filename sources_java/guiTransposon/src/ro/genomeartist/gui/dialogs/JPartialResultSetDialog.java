...
import ro.genomeartist.gui.mainpanels.partialresult.JPartialResultSetPane;
import java.awt.*;
 ...
 * @author iulian
 */
public class JPartialResultSetDialog extends JDialog {
     ...
     */
    public JPartialResultSetDialog(IGlobalManager globalManager, String title, boolean modal,
        ...
        //Middle pane
        middlePane = new JPartialResultSetPane(globalManager, partialResultSet);
    ...
    ActionListener buttonListener = new ActionListener() {
         ...
         */
            public void actionPerformed(ActionEvent e)
            {
                ...
                if (cmd.equals("ok")) JPartialResultSetDialog.this.dispose();
            }
        };
}
