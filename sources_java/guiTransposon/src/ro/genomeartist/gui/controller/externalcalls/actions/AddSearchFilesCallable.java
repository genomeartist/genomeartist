...
public class AddSearchFilesCallable extends AbstractProgressCallable<Vector<SearchFile>> {
     ...
     * @param isTransposon
     */
    public AddSearchFilesCallable(SearchFolder searchFolderRaw, boolean isTransposon) {
    ...
    public Vector<SearchFile> call() throws Exception {
        ...
        //parse the folder
        Vector<File> rawFiles = new Vector<File>(Arrays.asList(searchFolderRaw.selectedFiles)); //ExternalLink.getSequencesFromFolder(searchFolderRaw.folderLocation);
        ...
        try{
            ...
            while (fileIterator.hasNext()) {
                ...
                if (!fileExtension.equals(MyUtils.RAW_EXT)){
                    continue;
                }
                ...
                System.out.println("newSearchFile is "+newSearchFile.fileTitle);
