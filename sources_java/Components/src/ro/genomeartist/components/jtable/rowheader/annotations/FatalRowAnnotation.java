 ...
 * @author iulian
 */
public class FatalRowAnnotation extends AbstractRowAnnotation {
    ...
    public Icon getIcon() {
        if (suggestions != null && !suggestions.isEmpty()) {
            return RowHeaderIcons.FATAL_SUGGESTION.getIcon();
        } else {
            return RowHeaderIcons.FATAL.getIcon();
        }
    }
}
